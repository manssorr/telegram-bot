...
async function optimizeName(firstName, lastName, username) {
    let optimizedName = firstName.length > 3 ? firstName : username || "unknown";
    console.log(`🌹  > file: index.ts:70 > firstName.length < 3`, firstName.length < 3);
...
bot.on("message", async (ctx) => {
    ...
    ctx.reply(`إليك هذه القصيدة يا عزيزي ${username}، لانك من المميزين 😍 
